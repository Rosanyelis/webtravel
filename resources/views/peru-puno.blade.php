            ...
            <div class="inner-baner-container" style="background-image: url({{ asset('assets/images/inner-banner-2.png') }});">
                <div class="container">
                    <div class="inner-banner-content">
                        <h1 class="inner-title">{{ __('site.peru.cities.puno.title') }}</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 primary right-sidebar">
                            ...
                            <figure class="feature-image">
                                <img src="{{ asset('assets/images/puno2.webp') }}" alt="">
                            </figure>
                            <article class="single-content-wrap">
                                <h3 class="text-center">{{ __('site.peru.cities.puno.page_title') }}</h3>
                                <p>{{ __('site.peru.cities.puno.subtitle') }}</p>

                                <p>{{ __('site.peru.cities.puno.description') }}</p>
                            </article>
                        </div>
