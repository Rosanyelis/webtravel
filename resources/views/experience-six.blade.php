            ...
            <div class="inner-baner-container" style="background-image: url({{ asset('assets/images/inner-banner-2.png') }});">
                <div class="container">
                    <div class="inner-banner-content">
                        <h1 class="inner-title">{{ __('site.experience.romantic_vacations.title') }}</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 primary right-sidebar">
                            ...
                            <figure class="feature-image">
                                <img src="{{ asset('assets/images/by-theme/romantic-vacations-honeymoom.avif') }}" alt="{{ __('site.experience.romantic_vacations.title') }}">
                            </figure>
                            <article class="single-content-wrap">
                                <h3 class="text-center">{{ __('site.experience.romantic_vacations.title') }}</h3>
                                <p>{{ __('site.experience.romantic_vacations.content') }}</p>
                            </article>
                        </div>
