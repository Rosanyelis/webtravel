            ...
            <div class="inner-baner-container" style="background-image: url({{ asset('assets/images/inner-banner-2.png') }});">
                <div class="container">
                    <div class="inner-banner-content">
                        <h1 class="inner-title">{{ __('site.experience.small_group.title') }}</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 primary right-sidebar">
                            ...
                            <figure class="feature-image">
                                <img src="{{ asset('assets/images/small-group-adventures2.webp') }}" alt="">
                            </figure>
                            <article class="single-content-wrap">
                                <h3 class="text-center">{{ __('site.experience.small_group.title') }}</h3>
                                <p>{{ __('site.experience.small_group.subtitle') }}</p>
                                <p>{{ __('site.experience.small_group.content') }}</p>
                            </article>
                        </div>
